...
(function(Buffer, process) {
  ...
  Request.prototype.init = function(options) {
    ...
    self.once('pipe', function(src) {
      if (self.ntick)
        throw new Error("You cannot pipe to this stream after the first nextTick() after creation of the request stream.");
      self.src = src;
      if (isReadStream(src)) {
