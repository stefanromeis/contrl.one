...
(function(process) {
  ...
  module.exports = function(grunt) {
    grunt.initConfig({
      ...
      browserify: {dist: {
          files: {'build/auth0.js': ['standalone.js']},
          options: {debug: true}
        }},
      uglify: {
        options: {ascii: true},
        min: {files: {'build/auth0.min.js': ['build/auth0.js']}}
      },
      copy: {release: {files: [{
            expand: true,
            flatten: true,
      ...
      outdated: {release: {development: false}},
      aws_s3: {
        options: {
